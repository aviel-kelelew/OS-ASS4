...
00000000000011b4 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124c:	43078793          	addi	a5,a5,1072 # 8678 <big.1271>
...
0000000000002238 <bigargtest>:
{
  ...
  close(fd);
    ...
    22a0:	2dc78793          	addi	a5,a5,732 # 8578 <args.1860>
    22a4:	00006697          	auipc	a3,0x6
    22a8:	3cc68693          	addi	a3,a3,972 # 8670 <args.1860+0xf8>
    ...
    22c0:	2bc58593          	addi	a1,a1,700 # 8578 <args.1860>
